...
class FeatureEngineerB(BaseDataFetcher):
    ...
    def _extract_team_strength(self, home, away, baseline: dict = None) -> dict:
        ...
        if home and home.played and home.played > 0:
            ...
            feats["home_home_win_rate"] = (home.home_wins or 0) / max((home.home_wins or 0) + (home.home_draws or 0) + (home.home_losses or 0), self.DENOM_MIN_1)
        ...
        if away and away.played and away.played > 0:
            ...
            feats["away_away_win_rate"] = (away.away_wins or 0) / max((away.away_wins or 0) + (away.away_draws or 0) + (away.away_losses or 0), self.DENOM_MIN_1)
